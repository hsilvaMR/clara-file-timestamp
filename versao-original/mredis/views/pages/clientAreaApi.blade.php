			...
			<div class="row">
				<div class="col-md-4">
					<a href="{{ route('clientTimePage') }}">
						<div style="border:1px solid #ccc;padding:10px 15px;font-size:18px;margin-bottom:10px;">Dados da conta</div>
					</a>
					<a href="{{ route('clientTimeApiPage') }}">
						<div style="border:1px solid #4860AD;padding:10px 15px;font-size:18px;margin-bottom:10px;color:#4860AD;">Dados para API</div>
					</a>
					<a href="{{ route('clientTimePagPage') }}">
						<div style="border:1px solid #ccc;padding:10px 15px;font-size:18px;margin-bottom:10px;">Dados de Pagamento</div>
					</a>
				...
				<div class="col-md-8">
					@if(Cookie::get('time_user_compra_cookie'))
						...
						<input class="ip" type="" name="email" 
							@if($user->data_validade_selos != '0') value="{{ $user->data_validade_selos }}" @endif>
