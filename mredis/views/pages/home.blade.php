		...
		<form id="formCSelos" action="{{route('formCSelos')}}" name="form" method="post">
			...
			<div id="div_compra" style="padding:50px 0px;font-size:14px;display:none;">
				...
				<div style="border:1px solid #000;padding:30px 15px;margin-top:20px;text-align:left;">
					...
					<li>Comece por selecionar o(s) pacote(s) que deseja adquirir e realize o pagamento com o valor total
						(com IVA incluído).</li>
					<li>Preencha os dados para envio da Fatura.</li>

					<label style="margin-top:20px;">Se deseja adquirir quantidades diferentes das fornecidas acima, por
						favor contacte-nos através do número +351 000 000 000 (9h-18h) ou do endereço <a
				...
				<div style="border:1px solid #000;padding:30px 15px;margin-top:20px;text-align:left;">
					<div>
						<input type="radio" id="invoiceType1" name="invoiceType1" value="fatura_eletronica"
							checked="true">
					...
					<div style="display: block;margin:0px 0px 10px 25px;">
						<div>
							<label>Autorizo o envio da Fatura Eletrónica para o seguinte endereço de correio
								eletrónico</label>
							<br>
							<input style="width:calc(100% - 20px);" id="invoiceEmail" name="invoiceEmail"
								placeholder="xxxxxx@xxxx.xx" type="text" class="ip">
						</div>
					</div>
				</div>
				...
				<div style="text-align:left;font-size:12px;"><span class="tx-red">*</span> <label>Campos de submissão
						obrigatórios.</label></div>
				...
				<button class="bt bg-green float-right" id="customButton" type="submit"><i class="fas fa-check"></i>
