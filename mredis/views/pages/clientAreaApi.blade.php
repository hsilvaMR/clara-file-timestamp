		...
		<div class="row">
			<div class="col-md-4">
				<a href="{{ route('clientTimePage') }}">
					<div style="border:1px solid #ccc;padding:10px 15px;font-size:18px;margin-bottom:10px;">Dados da
						conta</div>
				</a>
				...
				<a href="{{ route('clientTimePagPage') }}">
					<div style="border:1px solid #ccc;padding:10px 15px;font-size:18px;margin-bottom:10px;">Dados de
						Pagamento</div>
				</a>
						...
						<form id="formCSelos" action="{{route('formCSelos')}}" name="form" method="post">
							...
							<div id="div_compra" style="padding:50px 0px;font-size:14px;display:none;">
								...
								<div style="border:1px solid #000;padding:30px 15px;margin-top:20px;text-align:left;">
									...
									<label style="font-size:18px;">Associe a conta à sua compra:</label><br><br>

									<select>
										<option value disabled selected>Selecione uma conta</option>
										@foreach($user_conta as $conta)
										<option value="{{ $conta->nome_conta }}">{{ $conta->nome_conta }}</option>
										@endforeach
									</select>
								</div>
								...
								<div style="border:1px solid #000;padding:30px 15px;margin-top:20px;text-align:left;">
									...
									<label style="font-size:18px;">Para adquirir Selos siga os três passos
										seguintes:</label><br><br>
									<li>Comece por selecionar o(s) pacote(s) que deseja adquirir e realize o pagamento
										com o valor total (com IVA incluído).</li>
									<li>Preencha os dados para envio da Fatura.</li>

									<label style="margin-top:20px;">Se deseja adquirir quantidades diferentes das
										fornecidas acima, por favor contacte-nos através do número +351 000 000 000
										(9h-18h) ou do endereço <a
											style="text-decoration:underline;color:#707070;font-weight:bold;"
											href="mailto:selos@mredis.com">selos@mredis.com</a>.</label>
								</div>
								...
								<div style="border:1px solid #000;padding:30px 15px;margin-top:20px;text-align:left;">
									<div>
										<input type="radio" id="invoiceType1" name="invoiceType1"
											value="fatura_eletronica" checked="true">
										<label for="invoiceType1">
											<span></span>Fatura Eletrónica
										</label><span class="tx-red"> *</span>
									</div>
									<div style="display: block;margin:0px 0px 10px 25px;">
										<div>
											<label>Autorizo o envio da Fatura Eletrónica para o seguinte endereço de
												correio eletrónico</label>
											<br>
											<input style="width:calc(100% - 20px);" id="invoiceEmail"
												name="invoiceEmail" placeholder="xxxxxx@xxxx.xx" type="text" class="ip">
										</div>
									</div>
								</div>
								...
								<div style="border:1px solid #000;padding:30px 15px;margin-top:20px;text-align:left;">
									...
									<div class="row">
										<div class="col-md-4">
											...
											<input class="ip" type="input" name="codigo_postal_entidade"
								...
								<div style="text-align:left;font-size:12px;"><span class="tx-red">*</span> <label>Campos
										de submissão obrigatórios.</label></div>
								...
								<div
									style="border:1px solid #0C31D4;padding:30px 15px 20px 15px;margin-top:20px;text-align:left;background-color:#C5CFFC;">
									<h5>Valor total: <span id="preco" style="color:#0C31D4;font-weight:bold;"></span> €
										+ IVA</h5>
									<input style="display:none;" id="preco_inicial" type="hidden" name="pacote"
										value="">
								</div>

								<button class="bt bg-green float-right" id="customButton" type="submit"><i
										class="fas fa-check"></i> Efetuar Pagamento</button>
