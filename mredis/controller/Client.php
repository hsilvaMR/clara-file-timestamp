...
class Client extends Controller
{
    ...
    public function index()
    {
        ...
        if (!empty($user_conta)) {
            ...
            //$user_conta = \DB::table('time_clients_conta')->where('id_cliente', $id_user)->first();
    ...
    public function formAddConta1(Request $request)
    {
        $id_user = Cookie::get('time_user_cookie');
        ...
        \DB::table('time_clients_conta')
            ->insert([
                ...
                'pais' => $pais,
                'nif' => $nif,
                'data_criacao' => strtotime(date('Y-m-d H:i:s')),
